...
int LSM9DS1Class::begin()
{
  ...
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x9B); // 238(new) Hz, 2000 dps, 16 Hz BW
...
int LSM9DS1Class::begin()
{
  ...
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x80); // 119 Hz(old) 232.18(new), 2000 dps, 16 Hz BW
